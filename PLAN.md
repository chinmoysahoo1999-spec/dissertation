...
- **2026-05-30 (final)** — **Shared eval-dataset downloader added at `Code/eval_datasets/00_download_eval_datasets.ipynb`**. Run once per HF account to produce `eval_*.parquet` files. All 20